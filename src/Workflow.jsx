...
const Workflow = () => {
    return (
        <div>
            <div className='py-25 bg-gradient-to-r from-blue-600 to-purple-700 text-white text-center space-y-3'>
                <h1 className='font-extrabold text-5xl'>Ready to Transform Your Workflow?</h1>
                <p className='text-[#FFFFFF]'>Join thousands of professionals who are already using Digitools to work smarter. <br />Start your free trial today.</p>
